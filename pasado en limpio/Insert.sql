...
VALUES
(16, '2025-03-01', 150000, '2026-03-01', 1),
(17, '2025-05-15', 175000, '2026-05-15', 1),
(18, '2025-09-10', 160000, '2026-09-10', 1);
...
INSERT INTO ALUMNOS (Sexo, FechaDeRegistro, Activo,IDUsuario)
VALUES
('Masculino', GETDATE(), 1, 1),
('Femenino',  GETDATE(), 1, 2),
('Masculino', GETDATE(), 1, 3),
('Femenino',  GETDATE(), 1, 4),
('Masculino', GETDATE(), 1, 5),
('Femenino',  GETDATE(), 1, 6),
('Masculino', GETDATE(), 1, 7),
('Femenino',  GETDATE(), 1, 8),
('Masculino', GETDATE(), 1, 9),
('Femenino',  GETDATE(), 1, 10),
('Masculino', GETDATE(), 1, 11),
('Femenino',  GETDATE(), 1, 12),
...
INSERT INTO ACTIVIDADES (IDForo, Titulo, Descripcion, FechaCreacion, FechaCierre, Activo)
VALUES
...
(1, 3, 51, 1,  'Cursos del Sol', 'certificado de finalización'),
(7, 3, 51, 3,  'Cursos del Sol', 'certificado de finalización'),
(13, 3, 51, 5, 'Cursos del Sol', 'certificado de finalización'),
(2, 3, 51, 7,  'Cursos del Sol', 'certificado de finalización'),
(8, 3, 51, 9,  'Cursos del Sol', 'certificado de finalización'),
(14, 3, 51, 11, 'Cursos del Sol', 'certificado de finalización'),

-- Curso Redes de Internet (Profesor 2, IDCurso = 69)
(3, 2, 69, 13, 'Cursos del Sol', 'certificado de finalización'),
(9, 2, 69, 15, 'Cursos del Sol', 'certificado de finalización'),
(15, 2, 69, 17, 'Cursos del Sol', 'certificado de finalización');
